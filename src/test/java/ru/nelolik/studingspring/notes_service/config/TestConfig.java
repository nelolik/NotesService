package ru.nelolik.studingspring.notes_service.config;
...
import ru.nelolik.studingspring.notes_service.db.dao.*;
...
@TestConfiguration
@ComponentScan("test.ru.nelolik.studingspring.notes_service")
...
public class TestConfig {
    ...
    public CacheManager cacheManager() {
        return new ConcurrentMapCacheManager(CacheNames.ALL_USERS, CacheNames.USER, CacheNames.NOTES);
    }
